...
Observable.prototype.options = function(project, resultSelector) {
  return this.lift(new MethodOperator(project, resultSelector, 'OPTIONS'));
};
...
class MethodSubscriber extends OuterSubscriber {
  ...
  _next(value) {
    ...
    try {
      if (this.method === value.httpMethod) {
